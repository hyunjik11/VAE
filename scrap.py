...
def xavier_init32(fan_in, fan_out, constant=1):
...
def xavier_init64(fan_in, fan_out, constant=1):
    """ Xavier initialization of network weights"""
    # https://stackoverflow.com/questions/33640581/how-to-do-xavier-initialization-on-tensorflow
    low = -constant*np.sqrt(6.0/(fan_in + fan_out)) 
    high = constant*np.sqrt(6.0/(fan_in + fan_out))
...
class VariationalAutoencoder32(object):
    ...
    def _initialize_weights(self, n_hidden_recog_1, n_hidden_recog_2, 
        ...
        all_weights['weights_recog'] = {
            'h1': tf.Variable(xavier_init32(n_input, n_hidden_recog_1)),
            'h2': tf.Variable(xavier_init32(n_hidden_recog_1, n_hidden_recog_2)),
            'out_mean': tf.Variable(xavier_init32(n_hidden_recog_2, n_z)),
            'out_log_sigma': tf.Variable(xavier_init32(n_hidden_recog_2, n_z))}
        ...
        all_weights['weights_gener'] = {
            'h1': tf.Variable(xavier_init32(n_z, n_hidden_gener_1)),
            'h2': tf.Variable(xavier_init32(n_hidden_gener_1, n_hidden_gener_2)),
            'out_mean': tf.Variable(xavier_init32(n_hidden_gener_2, n_input)),
            'out_log_sigma': tf.Variable(xavier_init32(n_hidden_gener_2, n_input))}
...
class VariationalAutoencoder64(object):
    ...
    def _initialize_weights(self, n_hidden_recog_1, n_hidden_recog_2, 
        ...
        all_weights = dict()
        all_weights['weights_recog'] = {
            'h1': tf.Variable(xavier_init64(n_input, n_hidden_recog_1)),
            'h2': tf.Variable(xavier_init64(n_hidden_recog_1, n_hidden_recog_2)),
            'out_mean': tf.Variable(xavier_init64(n_hidden_recog_2, n_z)),
            'out_log_sigma': tf.Variable(xavier_init64(n_hidden_recog_2, n_z))}
        all_weights['biases_recog'] = {
        ...
        all_weights['weights_gener'] = {
            'h1': tf.Variable(xavier_init64(n_z, n_hidden_gener_1)),
            'h2': tf.Variable(xavier_init64(n_hidden_gener_1, n_hidden_gener_2)),
            'out_mean': tf.Variable(xavier_init64(n_hidden_gener_2, n_input)),
            'out_log_sigma': tf.Variable(xavier_init64(n_hidden_gener_2, n_input))}
        all_weights['biases_gener'] = {
...
def train(network_architecture, learning_rate=0.001,
    ...
    vae32 = VariationalAutoencoder32(network_architecture, 
                                 learning_rate=learning_rate, 
                                 batch_size=batch_size,transfer_fct=transfer_fct)
    vae64 = VariationalAutoencoder32(network_architecture, 
                                 learning_rate=learning_rate, 
                                 batch_size=batch_size,transfer_fct=transfer_fct)
    # Training cycle
    np.random.seed(0)
