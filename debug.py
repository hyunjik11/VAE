...
class VariationalAutoencoder(object):
    ...
    def _initialize_weights(self, n_hidden_recog_1, n_hidden_recog_2, \
        ...
        variable_summaries(all_weights['biases_recog']['gener_biases_out_log_sigma'])
        return all_weights
...
def train(network_architecture, learning_rate=0.001,
    ...
    train_writer = tf.train.SummaryWriter('/Users/hyunjik11/Documents/VAE/summaries/train',vae.sess.graph)
    # Training cycle
    np.random.seed(0)
...
vae = train(network_architecture, training_epochs=120, display_step=1, transfer_fct=tf.nn.relu)
